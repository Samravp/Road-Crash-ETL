...
CREATE TABLE "ACCIDENT" (
    ...
    "ACCIDENT_LIGHT_CONDITION_ID" INT NOT NULL,
    "ACCIDENT_HIT_RUN_FLAG" VARCHAR NOT NULL,
    ...
    "ACCIDENT_WITHOUT_LICENSE" INT NOT NULL,
...
ALTER TABLE "REGION" ADD CONSTRAINT "FK_DEGREE_URBAN_ID" FOREIGN KEY("DEGREE_URBAN_ID","STATE_DIV_ID")
REFERENCES "DEGREE_URBAN" ("DEGREE_URBAN_ID","STATE_DIV_ID");
